...
Note: The number of digits in each group may vary; you can'y assume that groups have the 
lenghts shown in this example. Test your program with actual ISBN values (usually found
...
int main(void) {
    ...
    printf("Item number: %5d\nCheck digit: %1d", itemNumber, checkDigit);
    return 0;
